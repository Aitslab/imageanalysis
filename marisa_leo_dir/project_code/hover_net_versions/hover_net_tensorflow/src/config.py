...
class Config(object):
    def __init__(self, ):
        ...
        self.train_dir = ['../dataset/train/%s/'  % data_code_dict[self.model_type]]
        self.valid_dir = ['../dataset/valid/%s/' % data_code_dict[self.model_type]]
        ...
        self.save_dir = '%s/%s/00/00' % (self.log_path, self.model_name) # log file destination
        ...
        self.inf_data_dir = '../dataset/Test/Images/' #self.inf_data_dir = '../Nuclei_channel/training/training_nuclei/1_norm_images/'
