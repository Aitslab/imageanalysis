        ...
        "phase_list": [
            {
                "run_info": {
                    ...
                    "net": {
                        ...
                        "pretrained": "../dataset/pre_models/hovernet_original_consep_notype_tf2pytorch.tar",#ImageNet-ResNet50-Preact_pytorch.tar,
                        # 'pretrained': None,
                    },
                },
            ...
            },
            {
                "run_info": {
                    ...
                    "net": {
                        ...
                        # path to load, -1 to auto load checkpoint from previous phase,
                        # None to start from scratch
                        "pretrained": -1 #'../dataset/pre_models/hovernet_original_consep_notype_tf2pytorch.tar',
                    },
                },
                "target_info": {"gen": (gen_targets, {}), "viz": (prep_sample, {})},
