...
def train_step(batch_data, run_info):
    ...
    #print(batch_data.keys())  ##put nr_types in config.py to None
    ####
    imgs = batch_data["img"]
    ...
    if model.module.nr_types is not None:
        ...
        #print('trueeeeeeeeeeeeeeeee tpppppppppppppppppp')
        print(true_tp)
        #print('nrrrrrrrrrrrrr tyyyyyyyyyyyyyyyyypes')
        #print(model.module.nr_types)
